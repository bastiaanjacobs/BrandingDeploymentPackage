...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	<div class="wrapper article">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 refiner">
                        <WebPartPages:WebPartZone runat="server" Title="Side" ID="Side"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
                </div>
                <div class="col-md-9 refiner-results">
